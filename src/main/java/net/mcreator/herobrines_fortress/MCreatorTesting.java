...
public class MCreatorTesting extends Elementsherobrines_fortress.ModElement {
	public static final int ENTITYID = 10;
	public static final int ENTITYID_RANGED = 11;

	public MCreatorTesting(Elementsherobrines_fortress instance) {
		super(instance, 122);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("herobrines_fortress", "testing"), ENTITYID).name("testing").tracker(64, 1, true).egg(-1, -1).build());
	}
	...
	public static class EntityCustom extends EntityMob {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				MCreatorTestingEntityIsHurt.executeProcedure($_dependencies);
			}
