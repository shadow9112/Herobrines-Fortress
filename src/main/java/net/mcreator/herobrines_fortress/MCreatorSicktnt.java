...
public class MCreatorSicktnt extends Elementsherobrines_fortress.ModElement {
	@ObjectHolder("herobrines_fortress:sicktnt")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.TNT).sound(SoundType.SLIME).hardnessAndResistance(-1, 3600000).lightValue(15));
