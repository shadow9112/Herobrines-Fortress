...
public class MCreatorFirey extends Elementsherobrines_fortress.ModElement {
	@ObjectHolder("herobrines_fortress:firey")
	public static final ModDimension dimension = null;
	@ObjectHolder("herobrines_fortress:firey")
	public static final Item block = null;
	@ObjectHolder("herobrines_fortress:firey_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;

	public MCreatorFirey(Elementsherobrines_fortress instance) {
		super(instance, 9);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("firey"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("herobrines_fortress:firey")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("herobrines_fortress:firey"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("herobrines_fortress:firey"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("herobrines_fortress:fire")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new ModTrigger().setRegistryName("firey"));
	}

	public static class ModTrigger extends Item {
		public ModTrigger() {
			super(new Item.Properties().group(MCreatorCustomelements.tab).maxDamage(64));
		}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			if (random.nextInt(110) == 0)
				world.playSound(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
						.getValue(new ResourceLocation(("herobrines_fortress:Battlefield"))), SoundCategory.BLOCKS, 0.5f,
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, Direction p_180120_2_) {
				...
				return (this.world.getBlockState(framePos).getBlock() == Blocks.GOLD_BLOCK.getDefaultState().getBlock()) ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (!(this.world.getBlockState(framePos).getBlock() == Blocks.GOLD_BLOCK.getDefaultState().getBlock())) {
								break label56;
							}
				...
				for (int j7 = -1; j7 <= 1; ++j7) {
					for (int i8 = 1; i8 < 3; ++i8) {
						for (int i9 = -1; i9 < 3; ++i9) {
							...
							this.world.setBlockState(blockpos$mutableblockpos, flag ? Blocks.GOLD_BLOCK.getDefaultState().getBlock()
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutableblockpos, Blocks.GOLD_BLOCK.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		public BiomeProviderCustom(World world) {
			...
			for (Biome biome : this.biomes) {
				biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
					{
						carvableBlocks = ImmutableSet.of(Blocks.STONE.getDefaultState().getBlock(), biome.getSurfaceBuilder().getConfig().getTop()
