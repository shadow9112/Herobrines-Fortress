...
public class MCreatorFirey extends Elementsherobrines_fortress.ModElement {
	...
	@GameRegistry.ObjectHolder("herobrines_fortress:firey")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("herobrines_fortress:firey_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModTrigger().setUnlocalizedName("firey").setRegistryName("firey"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension firey is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("firey", "_firey", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("herobrines_fortress:firey", "inventory"));
	}
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("herobrines_fortress:Firey_ambient_sound",
					(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
							("herobrines_fortress:Firey_ambient_sound"))), 6000, 24000);
		}
				...
				for (int j7 = -1; j7 <= 1; ++j7) {
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							boolean flag = k8 < 0;
							this.world.setBlockState(new BlockPos(k9, k10, k11), flag ? Blocks.GOLD_BLOCK.getDefaultState().getBlock()
			...
			for (int i8 = 0; i8 < 4; ++i8) {
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? Blocks.GOLD_BLOCK.getDefaultState().getBlock()
				...
				for (int j1 = -2; j1 <= 2; ++j1) {
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							int k2 = k + k1 * 0 - j1 * 1;
							boolean flag = l1 < 0;
							this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? Blocks.GOLD_BLOCK.getDefaultState().getBlock()
									.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("firey_portal");
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, px, py, pz, vx, vy, vz);
			}
			if (random.nextInt(110) == 0)
				world.playSound(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,
						(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
								("herobrines_fortress:Battlefield"))), SoundCategory.BLOCKS, 0.5f, random.nextFloat() * 0.4F + 0.8F, false);
		}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("herobrines_fortress:fire")),};
