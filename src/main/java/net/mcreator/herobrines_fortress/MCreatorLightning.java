...
public class MCreatorLightning extends Elementsherobrines_fortress.ModElement {
	...
	@GameRegistry.ObjectHolder("herobrines_fortress:lightning")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("herobrines_fortress:lightning_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModTrigger().setUnlocalizedName("lightning").setRegistryName("lightning"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension lightning is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("lightning", "_lightning", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("herobrines_fortress:lightning", "inventory"));
	}
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("herobrines_fortress:Firey", (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation(("herobrines_fortress:Firey"))), 6000, 24000);
		}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("lightning_portal");
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.DRAGON_BREATH, px, py, pz, vx, vy, vz);
			}
			if (random.nextInt(110) == 0)
				world.playSound(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,
						(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(
								("herobrines_fortress:Firey"))), SoundCategory.BLOCKS, 0.5f, random.nextFloat() * 0.4F + 0.8F, false);
		}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("herobrines_fortress:lightingbiome")),};
