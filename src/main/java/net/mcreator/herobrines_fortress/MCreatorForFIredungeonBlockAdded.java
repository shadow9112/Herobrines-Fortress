...
public class MCreatorForFIredungeonBlockAdded extends Elementsherobrines_fortress.ModElement {
	public MCreatorForFIredungeonBlockAdded(Elementsherobrines_fortress instance) {
		super(instance, 101);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure MCreatorForFIredungeonBlockAdded!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure MCreatorForFIredungeonBlockAdded!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure MCreatorForFIredungeonBlockAdded!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure MCreatorForFIredungeonBlockAdded!");
			return;
		}
