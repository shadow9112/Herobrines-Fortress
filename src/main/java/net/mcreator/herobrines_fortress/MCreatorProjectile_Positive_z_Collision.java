...
public class MCreatorProjectile_Positive_z_Collision extends Elementsherobrines_fortress.ModElement {
	public MCreatorProjectile_Positive_z_Collision(Elementsherobrines_fortress instance) {
		super(instance, 181);
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure MCreatorProjectile_Positive_z_Collision!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure MCreatorProjectile_Positive_z_Collision!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure MCreatorProjectile_Positive_z_Collision!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure MCreatorProjectile_Positive_z_Collision!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure MCreatorProjectile_Positive_z_Collision!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) ((herobrines_fortressVariables.MapVariables.get(world).Player_Collision_x) - 1),
				...
				(int) (herobrines_fortressVariables.MapVariables.get(world).Player_collision_z)))).getBlock() == MCreatorProjectile_Positive_z.block
			...
			world.setBlockState(new BlockPos((int) ((herobrines_fortressVariables.MapVariables.get(world).Player_Collision_x) - 1),
				...
				(int) ((herobrines_fortressVariables.MapVariables.get(world).Player_collison_y) + 1), (int) z))).getBlock() == MCreatorProjectile_Positive_z.block
				.getDefaultState().getBlock())) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
			...
			world.setBlockState(new BlockPos((int) x, (int) ((herobrines_fortressVariables.MapVariables.get(world).Player_collison_y) + 1), (int) z),
				...
				(int) ((herobrines_fortressVariables.MapVariables.get(world).Player_collison_y) + 1),
				(int) ((herobrines_fortressVariables.MapVariables.get(world).Player_collision_z) - 2)))).getBlock() == MCreatorProjectile_Positive_z.block
				.getDefaultState().getBlock())) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
			...
			world.setBlockState(new BlockPos((int) ((herobrines_fortressVariables.MapVariables.get(world).Player_Collision_x) - 1),
				...
				(int) ((herobrines_fortressVariables.MapVariables.get(world).Player_collision_z) - 1)))).getBlock() == MCreatorProjectile_Positive_z.block
				.getDefaultState().getBlock())) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
			...
			world.setBlockState(new BlockPos((int) ((herobrines_fortressVariables.MapVariables.get(world).Player_Collision_x) - 2),
				...
				(int) (herobrines_fortressVariables.MapVariables.get(world).Player_collison_y), (int) (herobrines_fortressVariables.MapVariables
						.get(world).Player_collision_z)))).getBlock() == MCreatorProjectile_Positive_z.block.getDefaultState().getBlock())) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
			...
			world.setBlockState(
				...
				(int) (herobrines_fortressVariables.MapVariables.get(world).Player_collison_y), (int) z))).getBlock() == MCreatorProjectile_Positive_z.block
				.getDefaultState().getBlock())) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.AIR.getDefaultState(), 3);
				...
				(int) (herobrines_fortressVariables.MapVariables.get(world).Player_collison_y), (int) ((herobrines_fortressVariables.MapVariables
						.get(world).Player_collision_z) - 2)))).getBlock() == MCreatorProjectile_Positive_z.block.getDefaultState().getBlock())) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
			...
			world.setBlockState(
				...
				(int) (herobrines_fortressVariables.MapVariables.get(world).Player_collison_y), (int) ((herobrines_fortressVariables.MapVariables
						.get(world).Player_collision_z) - 1)))).getBlock() == MCreatorProjectile_Positive_z.block.getDefaultState().getBlock())) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
