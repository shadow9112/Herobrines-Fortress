...
public class MCreatorHow extends Elementsherobrines_fortress.ModElement {
	private KeyBinding keys;

	public MCreatorHow(Elementsherobrines_fortress instance) {
		super(instance, 150);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.how", Keyboard.KEY_1, "key.categories.misc");
