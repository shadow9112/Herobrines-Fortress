...
public class MCreatorPasswordTest extends Elementsherobrines_fortress.ModElement {
	public static HashMap guiinventory = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorPasswordTest(Elementsherobrines_fortress instance) {
		super(instance, 151);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("passwordtest"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("herobrines_fortress:textures/passwordtest.png");
		...
		public void render(int mouseX, int mouseY, float partialTicks) {
			...
			Password.render(mouseX, mouseY, partialTicks);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			Password = new TextFieldWidget(this.font, 150, 84, 120, 20, "Enter Password Here");
			guiinventory.put("text:Password", Password);
