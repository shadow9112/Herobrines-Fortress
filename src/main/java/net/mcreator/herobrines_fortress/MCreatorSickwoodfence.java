...
public class MCreatorSickwoodfence extends Elementsherobrines_fortress.ModElement {
	@ObjectHolder("herobrines_fortress:sickwoodfence")
	public static final Block block = null;

	public MCreatorSickwoodfence(Elementsherobrines_fortress instance) {
		super(instance, 163);
	}
