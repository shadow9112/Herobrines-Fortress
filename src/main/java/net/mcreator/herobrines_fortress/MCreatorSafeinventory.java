...
public class MCreatorSafeinventory extends Elementsherobrines_fortress.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("safeinventory"));
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public void initContainer(PlayerInventory inv, IInventory inheritedinv) {
			...
			Safe_inventory = new Inventory(30);
			guiinventory.put("Safe_inventory", Safe_inventory);
			this.addSlot(new Slot(inherited, 0, 9, 11) {
				@Override
			...
			this.addSlot(new Slot(inherited, 1, 29, 11) {
			});
			this.addSlot(new Slot(inherited, 2, 49, 11) {
			});
			this.addSlot(new Slot(inherited, 3, 69, 11) {
			});
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
