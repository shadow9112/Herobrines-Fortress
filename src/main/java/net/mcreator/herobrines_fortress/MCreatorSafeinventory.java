...
public class MCreatorSafeinventory extends Elementsherobrines_fortress.ModElement {
	public static int GUIID = 3;
	public static HashMap guiinventory = new HashMap();
	public static IInventory Safe_inventory;
	public static IInventory inherited;

	public MCreatorSafeinventory(Elementsherobrines_fortress instance) {
		super(instance, 138);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorSafe.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			Safe_inventory = new InventoryBasic("Safe_inventory", true, 30);
			guiinventory.put("Safe_inventory", Safe_inventory);
			this.addSlotToContainer(new Slot(inherited, 0, 9, 11) {
				@Override
			...
			this.addSlotToContainer(new Slot(inherited, 1, 29, 11) {
			});
			this.addSlotToContainer(new Slot(inherited, 2, 49, 11) {
			});
			this.addSlotToContainer(new Slot(inherited, 3, 69, 11) {
			});
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 12 + 8 + sj * 18, 35 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 12 + 8 + si * 18, 35 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("herobrines_fortress:textures/safeinventory.png");
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				MCreatorTest.executeProcedure($_dependencies);
			}
		}
