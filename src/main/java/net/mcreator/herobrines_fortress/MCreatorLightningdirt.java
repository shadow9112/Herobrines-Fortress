...
public class MCreatorLightningdirt extends Elementsherobrines_fortress.ModElement {
	@ObjectHolder("herobrines_fortress:lightningdirt")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(3f, 30f).lightValue(0).harvestLevel(2)
